    ...
    <section class="courses-area pt-100 pb-70">
        <div class="container">
            <div class="py-6 px-10">
                <h1 class="text-3xl leading-6 font-medium text-gray-900">Latest Posts</h1>
            </div>
            <div class="shorting">
            ...
            <div>
                ...
                <ul class="categories-list grid grid-cols-3 py-4 gap-4">
                    <li>
                        <a href="{{route('subCategory', ['video-animation'])}}" class="flex flex-col items-center">
                    ...
                    <li>
                        <a href="{{route('subCategory', ['music-audio'])}}" class="flex flex-col items-center">
                    ...
                    <li>
                        <a href="{{route('subCategory', ['graphics-design'])}}" class="flex flex-col items-center">
                    ...
                    <li>
                        <a href="{{route('subCategory', ['programming-tech'])}}" class="flex flex-col items-center">
                    ...
                    <li>
                        <a href="{{route('subCategory',['lifestyle'])}}" class="flex flex-col items-center">
                    ...
                    <li>
                        <a href="{{route('subCategory',['data'])}}" class="flex flex-col items-center">
